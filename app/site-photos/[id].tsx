        ...
        <Card className="mt-4">
          ...
          <View className="flex-row items-center py-2">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm font-medium text-gray-900">{item.takenBy || "N/A"}</Text>
            </View>
          </View>
          <View className="flex-row items-center py-2">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm font-medium text-gray-900">{item.takenAt || "N/A"}</Text>
            </View>
          </View>
          <View className="flex-row items-center py-2">
