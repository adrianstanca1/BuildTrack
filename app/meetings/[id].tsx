    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      <ScrollView className="px-4 py-4">
        <View className="flex-row items-center mb-4">
          ...
          <Pressable onPress={() => router.push(`/meetings/edit?id=${item.id}`)} className="p-2 mr-2">
        ...
        <Card className="mt-4">
          ...
          <View className="flex-row items-center py-2">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm font-medium text-gray-900">{item.meetingType || "N/A"}</Text>
            </View>
          </View>
          <View className="flex-row items-center py-2">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm font-medium text-gray-900">{item.scheduledAt || "N/A"}</Text>
            </View>
          </View>
          <View className="flex-row items-center py-2">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm font-medium text-gray-900">{item.durationMinutes + " min" || "N/A"}</Text>
            </View>
          </View>
          <View className="flex-row items-center py-2">
          ...
          <View className="flex-row items-center py-2">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm font-medium text-gray-900">{item.attendees.length + " attendees" || "N/A"}</Text>
            </View>
          </View>
          <View className="flex-row items-center py-2">
