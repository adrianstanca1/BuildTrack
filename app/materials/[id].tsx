    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      <ScrollView className="px-4 py-4">
        <View className="flex-row items-center mb-4">
          ...
          <Pressable onPress={() => router.push(`/materials/edit?id=${item.id}`)} className="p-2 mr-2">
        ...
        <Card className="mt-4">
          ...
          <View className="flex-row items-center py-2">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm font-medium text-gray-900">{item.quantityOnHand || "N/A"}</Text>
            </View>
          </View>
          <View className="flex-row items-center py-2">
          ...
          <View className="flex-row items-center py-2">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm font-medium text-gray-900">{fmtCurrency(item.unitCost)}</Text>
            </View>
          </View>
          <View className="flex-row items-center py-2">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm font-medium text-gray-900">{item.supplierName || "N/A"}</Text>
            </View>
          </View>
          <View className="flex-row items-center py-2">
