-- =========================================================================
-- Migration: Add submittals table + enhance RFIs and drawings for Supabase
-- Date: 2026-05-10
-- =========================================================================
...
CREATE TABLE IF NOT EXISTS submittals (
  ...
  ball_in_court UUID REFERENCES profiles(id) ON DELETE SET NULL,
...
-- Enhance RFIs
-- --------------------------------------------------------------------------
ALTER TABLE rfis ADD COLUMN IF NOT EXISTS ball_in_court UUID REFERENCES profiles(id) ON DELETE SET NULL;
